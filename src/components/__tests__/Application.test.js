...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduced the spots remaining for the first day by 1", async () => {
    ...
    //validation after save is clicked
  ...
  it("loads data, cancels an interview and increases the spots remaining for the first day by 1", async () => {
    ...
    expect(
      getByText(appointment, /would you like to delete?/i)
    ).toBeInTheDocument();
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, /unable to save/i));
